...
class YOLOSegmenter:
    ...
    def process_masks_gpu_batch(self, image: np.ndarray, masks_data: torch.Tensor, points: list):
        ...
        2. aligning: 旋转对齐 + 居中
        返回：List[aligned_image] 每个都是 (h, w, 3) 的 numpy array
        """
...
if __name__ == "__main__":
    ...
    # 初始化模型
    model = YOLOSegmenter()  # 或 yolov8n-seg.pt
    # 测试图像路径
